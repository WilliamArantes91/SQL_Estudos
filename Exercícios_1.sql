...
select * from DimProduct --Existem 2517 produtos cadastrados -- (a)
select * from DimCustomer -- Este número reduziu para 18.869 clientes na base de controle. --(b)
...
select CustomerKey as 'ID',FirstName as 'Nome',EmailAddress as 'E-mail',BirthDate as 'Data de Nascimento' from DimCustomer
...
select top(100) * from DimCustomer --(a)
select top(10) percent * from DimCustomer --(b)
select top(100) FirstName, EmailAddress,BirthDate from DimCustomer --(c)
select top(100) FirstName as 'Nome', EmailAddress as 'E-mail',BirthDate as 'Data de Nascimento' from DimCustomer --(d)
